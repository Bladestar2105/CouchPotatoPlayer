import { describe, test, expect, setSystemTime, beforeAll, afterAll } from './bunTestCompat';
...
describe('catchupUtils', () => {
  ...
  describe('generateCatchupUrl', () => {
    ...
    test('should return xc format by default if config is not provided', () => {
      ...
      expect(url).toBe(`http://test-server.com/timeshift/${username}/${password}/${durationMinutes}/${localXtreamStart}/12345.ts`);
    });
