...
**Status**
- 🟡 In Arbeit (Playback-, Library- und Collections-Slices extrahiert; zentrale Consumer migriert: `VideoPlayer`, `EpisodeScreen`, `PlayerScreen`, `ChannelList`, `SearchScreen`, `MediaInfoScreen`, `FavoritesList`, `RecentlyWatchedList`, `MovieList`, `SeriesList`, `EpgTimeline`).
