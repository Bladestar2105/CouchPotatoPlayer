...
import { useIPTV, useIPTVAppState, useIPTVProfiles } from '../context/IPTVContext';
...
const PlaylistManager = () => {
  ...
  const { editProfile } = useIPTV();
  const { addProfile, removeProfile, profiles, loadProfile, currentProfile } = useIPTVProfiles();
