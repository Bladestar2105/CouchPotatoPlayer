  ...
  const handleSubmit = () => {
    ...
    if (profileType === 'm3u') {
      ...
      if (!/^https?:\/\//i.test(trimmedUrl)) {
        Alert.alert(t('error'), t('urlHttpRequired'));
        return;
      }
      profileData = {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pickerContainer}>
        ...
        >
          ...
          <Picker.Item label={t('profileType.m3u')} value="m3u" color={Platform.OS === 'android' ? '#000' : '#FFF'} />
          <Picker.Item label={t('profileType.xtream')} value="xtream" color={Platform.OS === 'android' ? '#000' : '#FFF'} />
          <Picker.Item label={t('profileType.stalker')} value="stalker" color={Platform.OS === 'android' ? '#888' : '#888'} enabled={false} />
        </Picker>
      </View>
      ...
      {profileType === 'm3u' && (
        <>
          ...
          <TextInput style={styles.input} placeholder={t('placeholder.httpUrl')} value={url} onChangeText={setUrl} autoCapitalize="none" keyboardType="url" placeholderTextColor="#888" accessibilityLabel={t('m3uUrl')} />
        </>
      )}
      ...
      {profileType === 'xtream' && (
        <>
          ...
          <TextInput style={styles.input} placeholder={t('placeholder.serverUrl')} value={serverUrl} onChangeText={setServerUrl} autoCapitalize="none" keyboardType="url" placeholderTextColor="#888" accessibilityLabel={t('serverUrl')} />
