...
import { useIPTV, useIPTVCollections, useIPTVPlayback } from '../context/IPTVContext';
...
const MediaInfoScreen = () => {
  ...
  const { getVodInfo, getSeriesInfo, series } = useIPTV();
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: 'rgba(233,105,42,0.3)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
